...
| **Frontend (Mobile)** | 📱 **React Native**                  | Cross-platform mobile app for patients/doctors: video call, chat, health records     |
...
| ------ | ----------------------------------------------------------- | ----------------------------------------- |
| 1️⃣    | React Native app + React portal + Node.js REST API skeleton | React Native, React, Node                 |
| 2️⃣    | User auth, video consultation (WebRTC)                      | Node.js + Socket.IO + React Native WebRTC |
...
| │ └── `react-native-app/` | Mobile app for patients & doctors (React Native)                       |
...
Would you like me to **generate this as a downloadable `.docx` file** (with formatted headings, architecture diagram, and emoji icons intact)?
